...
//  Neumorphism
//
//  Created by Andoni da Silva Otero on 24/03/2020.
...
extension Color {
    ...
    static let lighStart = Color(red: 60 / 255, green: 160 / 255, blue: 240 / 255)
...
struct ColorfulBackground<S: Shape>: View {
    ...
    var body: some View {
        ...
        ZStack {
            if isHighlighted  {
                shape
                    .fill(LinearGradient(Color.lightEnd, Color.lighStart))
                    .overlay(shape.stroke(LinearGradient(Color.lighStart, Color.lightEnd), lineWidth: 4))
